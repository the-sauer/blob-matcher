...
_C.BLOBINATOR = CN()
_C.BLOBINATOR.SEED = 0x1234
_C.BLOBINATOR.PATTERN_HEIGHT = 800
_C.BLOBINATOR.PATTERN_WIDTH = 600
_C.BLOBINATOR.BOARD_DIR = "./out"
_C.BLOBINATOR.BACKGROUND_DIR = "./data/backgrounds/NotreDame/images"
_C.BLOBINATOR.PATCH_SCALE_FACTOR = 16.0
_C.BLOBINATOR.BLOBS_PER_IMAGE = 32
_C.BLOBINATOR.HOMOGRAPHIES_PER_IMAGE = 3
_C.BLOBINATOR.NUM_BACKGROUND_IMAGES = 512
_C.BLOBINATOR.NUM_BACKGROUND_IMAGES_BATCH = 16
_C.BLOBINATOR.BACKGROUND_DATASET = "itsahmad/indoor-scenes-cvpr-2019"
