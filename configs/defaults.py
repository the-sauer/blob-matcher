...
_C.BLOBINATOR.BLOBS_PER_IMAGE = 200
_C.BLOBINATOR.HOMOGRAPHIES_PER_IMAGE = 1
_C.BLOBINATOR.TRAINING_DATASET_SIZE = 100_000
_C.BLOBINATOR.TRAINING_NUM_BACKGROUNDS = 100
_C.BLOBINATOR.VALIDATION_NUM_BACKGROUNDS = 10

_C.BLOBINATOR.VALIDATION_DATASET_SIZE = 10_000

# _C.BLOBINATOR.NUM_BACKGROUND_IMAGES_BATCH = 16
_C.BLOBINATOR.BACKGROUND_DATASET = "itsahmad/indoor-scenes-cvpr-2019"

_C.BLOBINATOR.VALIDATION = CN()
_C.BLOBINATOR.VALIDATION.KEYPOINT_SPLIT = 0.2
_C.BLOBINATOR.VALIDATION.BACKGROUND_SPLIT = 0.2
