...
_C.TRAINING.BOARDS = ['a07', '94a', '717', 'a4b', 'cdc', 'fd6', '649', '5bf', 'e14', '90d', '99c', 'af2', 'd88', 'a94', '867', '60c', '858', 'a33', 'ccd', '860', 'e02', '546', '877', '2e0', '291', '1a7', 'f5c']

_C.TEST.SEQUENCES = ['C0012', 'C0023', 'C0034', 'C0047', 'C0058', 'C0071', 'MVI_3150', 'MVI_3161']
_C.TEST.BOARDS = ['049', 'bb5', '0de', '55c', 'd22']

_C.VALIDATION = CN()
_C.VALIDATION.SEQUENCES = ['C0013', 'C0024', 'C0035', 'C0048', 'C0059', 'MVI_3141', 'MVI_3151']
_C.VALIDATION.BOARDS = ['930', '5bb', 'b40', 'bf0']
